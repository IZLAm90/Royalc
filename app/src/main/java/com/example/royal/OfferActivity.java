...
import com.example.royal.ui.ViewModelOffer;
...
public class OfferActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    CollectionReference notebookRef = db.collection("Offers");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav();
        startRecyclerView();
        findViewById(R.id.fabbb).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void startRecyclerView() {
        ...
        FirestoreRecyclerOptions options = new FirestoreRecyclerOptions.Builder<OfferModel>()
                .setQuery(query, OfferModel.class)
                .build();
        adapter = new OfferAdapter(options, getApplicationContext());
        Toast.makeText(getApplicationContext(), options.getSnapshots().toString(), Toast.LENGTH_LONG).show();
